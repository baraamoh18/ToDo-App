...
function LogIn() {
    ...
    return (
        <div className="flex justify-center items-center flex-col min-h-screen bg-gradient-to-br">
            <div 
                onClick={() => navigate("/")} 
                className="fixed top-0 left-0 ml-4 mt-4 min-w-1.5 flex items-center cursor-pointer"
            >
